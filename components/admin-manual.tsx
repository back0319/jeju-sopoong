...
export function ManualOrder({ catalog, order, onDone, onClose }: {
  ...
  return <div className="overlay"><section role="dialog" aria-modal="true"
    ...
    <fieldset disabled={busy} className="editor-body"><div className="editor-items">
      {items.map((item, n) => <article className="editor-item" key={n}>
        ...
        {item.kind !== "extra" && <>
          ...
          <div><h3>추가 토핑</h3><div className="editor-choices">{catalog.ingredients.filter(i => i.kind === "topping").map(i => {
